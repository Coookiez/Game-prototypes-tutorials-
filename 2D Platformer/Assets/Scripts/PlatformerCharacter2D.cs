...
namespace UnitySampleAssets._2D {
    ...
    public class PlatformerCharacter2D : MonoBehaviour {
        ...
        Transform playerGraphics; // Reference to the graphics so that we can change direction
        ...
        private void Awake() {
            ...
            if (playerGraphics == null) {
                Debug.LogError("\"Graphics\" sprite unavailable");
            }
        ...
        private void Start() {
            ...
            if (audioManager == null) {
                Debug.LogError("No audioManager in PlatformerCharacter2D script");
            }
        }
        ...
        private void FixedUpdate() {
            ...
            if(wasGrounded != grounded && grounded == true && rb2D.velocity.y != 0) {
